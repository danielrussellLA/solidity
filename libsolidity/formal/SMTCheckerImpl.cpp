...
void SMTCheckerImpl::endVisit(VariableDeclarationStatement const&)
{
}
...
void SMTCheckerImpl::endVisit(Assignment const&)
{
}
...
void SMTCheckerImpl::checkCondition(z3::expr _condition, SourceLocation const& _location, string const& _description)
{
	m_solver.push();
	...
	case z3::check_result::sat:
		m_errorReporter.warning(_location, _description + " happens here for: ...");
		break;
